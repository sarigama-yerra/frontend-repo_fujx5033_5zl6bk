      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="mt-8 grid sm:grid-cols-3 gap-6">
          <div className="bg-slate-900/60 border border-white/10 rounded-xl p-5">
            ...
            <p className="text-slate-400 text-sm mt-1">Immersive 3D hero and smooth UX to keep visitors exploring.</p>
          </div>
          <div className="bg-slate-900/60 border border-white/10 rounded-xl p-5">
            <h3 className="text-white font-semibold">Educational</h3>
            <p className="text-slate-400 text-sm mt-1">Curated library draws from Amazon, YouTube, and major streaming platforms.</p>
          </div>
          <div className="bg-slate-900/60 border border-white/10 rounded-xl p-5">
            <h3 className="text-white font-semibold">Environment‑minded</h3>
            <p className="text-slate-400 text-sm mt-1">Digital products reduce shipping and waste while scaling globally.</p>
          </div>
        </div>
      </div>
    </section>
